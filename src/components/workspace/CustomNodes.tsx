...
export const SafeNode = ({ data }: any) => (
  <div className="relative bg-zinc-800/90 border border-emerald-500/30 rounded-xl p-3 min-w-[160px] shadow-lg">
...
export const TenseNode = ({ data }: any) => (
  <div className="relative bg-zinc-800/90 border border-amber-500/30 rounded-xl p-3 min-w-[160px] shadow-lg">
    <NotificationBadge needsUpdate={data.needsUpdate} />
...
export const HostileNode = ({ data }: any) => (
  <div className="relative bg-zinc-800/90 border border-red-500/40 rounded-xl p-3 min-w-[160px] shadow-lg">
    <NotificationBadge needsUpdate={data.needsUpdate} />
...
export const MysteryNode = ({ data }: any) => (
  <div className="relative bg-zinc-800/50 border border-dashed border-zinc-500/50 rounded-xl p-3 min-w-[160px]">
    <NotificationBadge needsUpdate={data.needsUpdate} />
...
export const nodeTypes = { safe: SafeNode, tense: TenseNode, hostile: HostileNode, mystery: MysteryNode, region: RegionNode }